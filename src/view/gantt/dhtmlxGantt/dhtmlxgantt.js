	...
	return function(t) {
		...
		t.exports = function(t) {
			...
			return n(r, e), r.prototype.render = function(e) {
				...
				}, this), _.onchange = t.bind(m, this), "string" == typeof(s = t._resolve_default_mapping(r)) && (s = {
					start_date: s
				}), l = n[s.start_date] || new Date, c = n[s.end_date] || t.calculateEndDate({
					start_date: l,
					duration: 1,
					task: n
		...
		var n = i(17);
		t.exports = function(t) {
			i(86)(t), n.prototype.getGridColumns = function() {
					...
					return {
						...
						update: function(t, i, r, c) {
							for(var u = r.$getConfig(), h = r.$getTemplates(), f = r.getScale(), _ = l(t, u.resource_property, f, r), g = t.capacity || r.$config.capacity || 24, p = {}, v = 0; v < _.length; v++) {
								...
								if(d(y, f, c)) {
									var w = e[t.id];
									if(w && w[y]) w && w[y] && !w[y].parentNode && i.appendChild(w[y]);
									else {
										var x = s(t, k, g, u, h, m);
		...
		t.exports = function(t) {
			t.ext || (t.ext = {});
			for(var e = [i(97), i(96), i(95), i(94), i(93), i(92), i(91), i(90)], n = 0; n < e.length; n++) e[n] && e[n](t);
			var r = i(89).default;
			t.ext.zoom = new r(t)
		}
	}, function(t, e, i) {
		...
		var l = function() {
			...
			return t.prototype.setTransactionMode = function(t, e) {
				...
				if(t) {
					...
					var c = this.getState(e),
						...
						f = void 0;
					if(this._router instanceof Function) f = this._router(d, u, t, e);
					else if(this._router[d] instanceof Function) f = this._router[d](u, t, e);
					else switch(c) {
						case "inserted":
			...
			}, t.prototype.enableDebug = function(t) {}, t.prototype.setOnBeforeUpdateHandler = function(t) {
		...
		var n = i(3),
			...
			s = function(t) {
				...
				}, e.prototype._updateLinkedViews = function() {}, e.prototype._initMouseWheel = function() {
		...
		i(21), t.exports = function() {
			var t = new function() {
				this.constants = i(167), this.version = "6.2.7", this.license = "site", this.templates = {}, this.ext = {}, this.keys = {
					edit_save: this.constants.KEY_CODES.ENTER,
					edit_cancel: this.constants.KEY_CODES.ESC
				}
			};
			i(166)(t), t.$services = t.$inject(i(165)), t.config = t.$inject(i(164)), t.ajax = i(163)(t), t.date = i(161)(t);
			var e = i(160)(t);
			...
			var a = i(0);
			a.mixin(t, a), t.Promise = i(157), t.env = i(8);
			var o = i(1);
			t.utils = {
				dom: {
			...
			var s = i(22)();
			t.event = s.attach, t.eventRemove = s.detach, t._eventRemoveAll = s.detachAll, t._createDomEventScope = s.extend, a.mixin(t, i(153)(t));
			var l = i(152).init(t);
			...
			}), t.mixin(t, l.layersApi), i(110)(t), t.$services.setService("layers", function() {
				return l.layersService
			});
			var c = i(109);
			t.mixin(t, c()), i(108)(t);
			var u = i(102);
			return t.dataProcessor = u.DEPRECATED_api, t.createDataProcessor = u.createDataProcessor, i(98)(t), i(88)(t), i(87)(t), i(85)(t), i(84)(t), i(83)(t), i(82)(t), i(73)(t), i(72).default(t), i(71)(t), i(61)(t), i(60)(t), i(58)(t), i(57)(t), i(56)(t), i(55)(t), i(54)(t), i(53)(t), i(52)(t), i(51)(t), i(50)(t), i(49)(t), i(48)(t), i(47)(t), i(45)(t), i(44).default(t), t
		}
	}, function(t, e, i) {
		var n = {
			_seed: 0,
			...
			getGanttInstance: function() {
				for(var t = i(168)(), e = 0; e < n._ganttPlugin.length; e++) n._ganttPlugin[e](t);
